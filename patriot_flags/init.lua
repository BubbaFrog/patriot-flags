----------------------------------------------------------
-- Minetest :: Patriotic Flags Mod (patriot_flags)
--
-- See README.txt for licensing and other information
-- Code adapted from "pride_flags" mod by Leslie E. Krause
-- Copyright (c) 2022, BubbaFrog
--
-- ./games/minetest_game/mods/patriot_flags/init.lua
----------------------------------------------------------
...
local flag_list = {"trump", "anticommie2", "letsgobrandon", "america", "dixie", "comeand", "mississipi", "starsandbars", "police", "kylerittenhouse", "georgia", "anticommie", "comeand2", "powmia", "trump2", "fb", "yeeyee", "1776", "jfk",  }
...
minetest.register_entity( "patriot_flags:wavingflag", {
	initial_properties = {
		...
		pointable = false,
		mesh = "wavingflag.b3d",
		textures = { string.format( "patriot_flags_%s.png", flag_list[1] ) },
...
print( cur_wind )
	...
	reset_texture = function ( self, flag_idx )
		...
		local texture = string.format( "patriot_flags_%s.png", flag_list[ self.flag_idx ] )
